...
const updateHorseSchema = z.object({
  ...
  birthDate: z.string().refine((v) => !isNaN(Date.parse(v)), { message: 'Invalid date' }).optional(),
...
router.delete('/:id/regular-jockeys/:jockeyId', authorize('owner'), horseController.removeRegularJockey);
