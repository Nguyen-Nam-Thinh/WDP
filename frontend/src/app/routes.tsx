...
export const router = createBrowserRouter([
  ...
  // Protected — phải đăng nhập
  {
    ...
    children: [
      ...
      { path: "/horse-owner/race-results", element: <HorseOwnerDashboard /> },
      { path: "/horse-owner/wallet", element: <HorseOwnerDashboard /> },
      { path: "/horse-owner/penalties", element: <HorseOwnerDashboard /> },
      ...
      { path: "/jockey/race-results", element: <JockeyDashboard /> },
      { path: "/jockey/penalties", element: <JockeyDashboard /> },
      ...
      { path: "/referee/live", element: <RefereeDashboard /> },
      { path: "/referee/results", element: <RefereeDashboard /> },
