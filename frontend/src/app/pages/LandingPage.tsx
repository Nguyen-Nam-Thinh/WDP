              ...
              {featuredRace ? (
                <>
                  ...
                  <p className="text-muted-foreground">
                    Cự ly {featuredRace.distance}m · Giải thưởng {featuredRace.purse.toLocaleString('vi-VN')} coins
                  </p>
                </>
              ) : (
                <>
                ...
                <div className="absolute bottom-6 left-6 right-6 flex items-end justify-between">
                  ...
                  {featuredRace && (
                    <div className="text-right hidden sm:block">
                      ...
                      <div className="text-gold font-bold">{featuredRace.purse.toLocaleString('vi-VN')} coins</div>
                    </div>
                  )}
                </div>
              </div>
