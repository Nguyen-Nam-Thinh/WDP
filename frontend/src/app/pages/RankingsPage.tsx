                      ...
                      <div className="px-6 py-4 border-b border-border flex flex-wrap items-center gap-4">
                        ...
                        <div className="flex items-center gap-3 ml-auto flex-wrap">
                          ...
                          <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
                            ...
                            <span className="text-gold font-semibold">{selectedRace.purse.toLocaleString('vi-VN')} coins</span>
                          </div>
                        </div>
                      </div>
                    )}
                          ...
                          <tbody>
                            {raceResults.map((entry) => (
                              <tr key={entry._id} className="border-b border-border hover:bg-muted/40 transition-colors">
                                ...
                                <td className="px-4 py-4 text-center">
                                  {entry.prizeAmount > 0 ? (
                                    <span className="text-gold font-bold tabular-nums">{entry.prizeAmount.toLocaleString('vi-VN')} coins</span>
                                  ) : (
                                    <span className="text-muted-foreground">—</span>
                                  )}
                                </td>
                        ...
                        <tr key={item._id} className="border-b border-border hover:bg-muted/40 transition-colors group">
                          ...
                          <td className="px-4 py-4 text-center">
                            {tab === 'horses' ? (
                              ...
                              <span className="text-gold font-bold text-sm tabular-nums">{item.totalEarnings.toLocaleString('vi-VN')} coins</span>
                            ) : (
